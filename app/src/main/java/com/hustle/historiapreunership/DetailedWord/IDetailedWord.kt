...
class IDetailedWord : AppCompatActivity() {
            ...
            override fun onItemClick(position: Int) {
                when (position) {
                    0 -> {
                        ...
                        intent.putExtra(SearchManager.QUERY,R.string.Indonesia)
                        startActivity(intent)
                    }
                    1 -> {
                        val intent = Intent(Intent.ACTION_WEB_SEARCH)
                        intent.putExtra(SearchManager.QUERY,R.string.Iran)
                        startActivity(intent)
                    }
                    2 -> {
                        val intent = Intent(Intent.ACTION_WEB_SEARCH)
                        intent.putExtra(SearchManager.QUERY,R.string.Italia)
                        startActivity(intent)
                    }
                }
            }
