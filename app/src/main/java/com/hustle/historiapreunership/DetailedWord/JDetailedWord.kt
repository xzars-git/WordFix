...
class JDetailedWord : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        abjad = arrayListOf(
            getString(R.string.Jamaika),
            getString(R.string.Jepang),
            getString(R.string.Jerman)
        )
            ...
            override fun onItemClick(position: Int) {
                when (position) {
                    0 -> {
                        ...
                        intent.putExtra(SearchManager.QUERY,R.string.Jamaika)
                        startActivity(intent)
                    }
                    1 -> {
                        val intent = Intent(Intent.ACTION_WEB_SEARCH)
                        intent.putExtra(SearchManager.QUERY,R.string.Jepang)
                        startActivity(intent)
                    }
                    2 -> {
                        val intent = Intent(Intent.ACTION_WEB_SEARCH)
                        intent.putExtra(SearchManager.QUERY,R.string.Jerman)
                        startActivity(intent)
                    }
                }
            }
