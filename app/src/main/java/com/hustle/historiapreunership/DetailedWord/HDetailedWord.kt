...
class HDetailedWord : AppCompatActivity() {
            ...
            override fun onItemClick(position: Int) {
                when (position) {
                    0 -> {
                        ...
                        intent.putExtra(SearchManager.QUERY,R.string.Haiti)
                        startActivity(intent)
                    }
                    1 -> {
                        val intent = Intent(Intent.ACTION_WEB_SEARCH)
                        intent.putExtra(SearchManager.QUERY,R.string.Honduras)
                        startActivity(intent)
                    }
                    2 -> {
                        val intent = Intent(Intent.ACTION_WEB_SEARCH)
                        intent.putExtra(SearchManager.QUERY,R.string.Hungaria)
                        startActivity(intent)
                    }
                }
            }
